...
- `rotations.weekdayEvenings` for the weekday evening rotation;
...
- RS has no adequate break on a long or early-plus-evening day;
...
- DP is assigned to weekend/on-call cover;
- weekend/on-call rotation assigns the wrong RS/AS person;
- weekday early-start rotation assigns the wrong RS/AS person;
- weekday evening rotation assigns the wrong RS/AS person;
- the same person is assigned weekday early starts and weekday evenings in the same week;
...
- evening hours from 18:00 to 22:00 Eastern;
- early-start hours;
